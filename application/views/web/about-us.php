...
<html lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/web/css/responsee.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/css/lightcase.css">
    <!-- CUSTOM STYLE -->      
  ...
  <body class="size-1140">
            ...
            <div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=base_url()?>assets/web/img/img-03.jpg" alt=""></a>
                ...
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=base_url()?>assets/web/img/img-04.jpg" alt=""></a>
                ...
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=base_url()?>assets/web/img/img-05.jpg" alt=""></a>
            ...
            <div class="line">      
              ...
              <div class="margin2x">                                                                                              
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-5.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-2.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-3.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-4.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-5.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=base_url()?>assets/web/img/logo-1.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=base_url()?>assets/web/img/logo-2.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=base_url()?>assets/web/img/logo-3.png" alt="">                                                                                                                                                            
                </div>             
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=base_url()?>assets/web/img/logo-4.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=base_url()?>assets/web/img/logo-1.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=base_url()?>assets/web/img/logo-3.png" alt="">                                                                                                                                                            
                </div>             
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img src="<?=base_url()?>assets/web/img/logo-4.png" alt="">                                                                                                                                                            
                </div>                                                                                                                                                                                              
              </div>
            </div>
          </section>
    ...
    <script type="text/javascript" src="<?=base_url()?>assets/web/js/responsee.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/web/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/web/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/web/js/template-scripts.js"></script> 
  </body>
</html>